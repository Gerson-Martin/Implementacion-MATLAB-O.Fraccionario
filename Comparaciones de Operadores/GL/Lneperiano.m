...
%Function Base
subplot(3,1,1);
plot(t,funcion_base);xlim([0.01 0.1]);
legend('f(t)=ln(2t)','Location','southeast');
title('Funcion Base');grid minor;
%Derivative Function
subplot(3,1,2);
plot(t,fDf(1:N,:));xlim([0.01 0.1]);
legend('α=0.1','α=0.3','α=0.5','α=0.7','α=1','Location','southeast');grid minor;
